				...
				collector.on('collect', m => {
					...
					collector2.on('collect', m => {
						...
						if (color == 'black') {
							...
							// fs.writeFileSync('./lib/database/misc/games/chess/chess_games.json', JSON.stringify(games, null, 2))
							boardNew = functions.drawBoard(JSON.parse(fs.readFileSync('./lib/database/misc/games/chess/chess_games.json', 'utf8'))[interaction.guild.id].games[gameID].boardConfig)
