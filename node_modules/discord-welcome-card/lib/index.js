...
function drawCard(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (avatar) {
            ...
            if (avatarImage) {
                ctx.drawImage(yield (0, lib_1.toImage)(avatarImage), h / 2 - radius + ((_o = avatar.outlineWidth) !== null && _o !== void 0 ? _o : 0), //x
                h / 2 - radius + ((_p = avatar.outlineWidth) !== null && _p !== void 0 ? _p : 0), //y
                radius * 2 - ((_q = avatar.outlineWidth) !== null && _q !== void 0 ? _q : 0) * 2, //width
                radius * 2 - ((_r = avatar.outlineWidth) !== null && _r !== void 0 ? _r : 0) * 2 //height
                );
            }
            if (outlineWidth) {
                ...
                ctx.strokeStyle = ((_s = outlineColor !== null && outlineColor !== void 0 ? outlineColor : theme.color) !== null && _s !== void 0 ? _s : '#fff').toString(ctx, ctx.h / 2 - r, h / 2 - r, h / 2 + r, h / 2 + r);
                ctx.stroke();
            }
        }
        (0, lib_1.snap)(canvas);
